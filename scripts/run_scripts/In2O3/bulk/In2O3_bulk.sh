...
#$ -N phonons           # name of job (will appear in output of qstat)
#$ -o $JOB_NAME.o$JOB_ID
#$ -e $JOB_NAME.e$JOB_ID
#$ -q any
...
# python ../../../scripts/run-model-test.py  -Nl In2O3 GAP_itB_3_b_4_virials2 $args ../../../../tests/In2O3/vacancy_In2O3_singleunit_Ia3
