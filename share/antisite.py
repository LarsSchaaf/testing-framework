...
def do_farthest_inequiv_pairs(test_dir, tol=1.0e-2):
    ...
    equiv_at = set(
        [tuple(iZ) for iZ in zip(sym_data["equivalent_atoms"], bulk_supercell.numbers)]
    )
    ...
    for i1, i2 in antisite_list:
        (
            ...
            Z1,
            Z2,
        ) = do_one_antisite_pair(bulk_supercell, bulk_supercell_pe, i1, i2, tol)
